...
function updateCanvas(){
    var number = Math.floor((Math.random()*quick_draw_data_set.length)+1);
    console.log(number);
    sketch = (quick_draw_data_set[number]);
    console.log(sketch);
    document.getElementById('to-be-drawn').innerHTML = "Sketch to be drawn :" +sketch;
}
var timer_counter = 0;
var timer_check = "";
var drawn_sketch = "";
...
var score = 0;
function doodle(){
    console.log("Showing all available doodles");
    console.log("All doodles");
    console.log("Showing all 345 doodles");
...
function check_sketch(){
    ...
    if(timer_check=="completed"|| anwser_holder=="set"){
        timer_check=""
        console.log(timer_check);
        anwser_holder="";
        updateCanvas()
